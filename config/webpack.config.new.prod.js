...
module.exports = {
  // https://www.webpackjs.com/configuration/other-options/#bail
  ...
  optimization: {
    ...
    minimizer: [
      new UglifyJsPlugin({
        ...
        sourceMap: shouldUseSourceMap,
        uglifyOptions: {
          ie8: false, // 是否支持IE8，默认是false，此处是为了说明
          compress: {
            warnings: false, // 删除无法访问的代码或未使用的声明等时显示警告
            dead_code: true, // 删除无法访问的代码，默认为true
            drop_debugger: true, // 移除debugger声明
            // Disabled because of an issue with Uglify breaking seemingly valid code:
            // https://github.com/facebook/create-react-app/issues/2376
            // Pending further investigation:
            // https://github.com/mishoo/UglifyJS2/issues/2011
            comparisons: false, // apply certain optimizations to binary nodes, e.g. !(a <= b) → a > b (only when unsafe_comps)
